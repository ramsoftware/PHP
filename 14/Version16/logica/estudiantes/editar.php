...
$SQL = "SELECT codigo, nombre1, nombre2, apellido1, apellido2, tiposangre, altura, peso, colorojos, DATE_FORMAT(fechanace, '%Y-%m-%d') as fecha, colorprefiere, profesion, nacionalidad, correo, url, celular, estadocivil, ciudadtrabaja, observacion FROM estudiantes WHERE codigo = :codigo";

...
//Prepara la búsqueda. Corrige contra la inyección SQL
$nombre = $_GET['nombre'];
$nombreSeguro = "%$nombre%";
$SQL = "SELECT codigo, nombre FROM colores WHERE nombre LIKE :nombre ORDER BY nombre LIMIT 0, 10";
$Sentencia = $BaseDatos->Conexion->prepare($SQL);
$Sentencia->bindParam(':nombre', $nombreSeguro, PDO::PARAM_STR);
$Sentencia->execute();

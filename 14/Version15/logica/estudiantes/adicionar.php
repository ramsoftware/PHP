...
$SQL = "INSERT INTO estudiantes(nombre1, nombre2, apellido1, apellido2, tiposangre, altura, peso, colorojos, fechanace, colorprefiere, profesion, nacionalidad, correo, url, celular, estadocivil, ciudadtrabaja, observacion) VALUES(:nombre1, :nombre2, :apellido1, :apellido2, :tiposangre, :altura, :peso, :colorojos, :fechanace, :colorprefiere, :profesion, :nacionalidad, :correo, :url, :celular, :estadocivil, :ciudadtrabaja, :observacion)";

...
$SQL = "SELECT nombre, pais FROM ciudades WHERE codigo = :Codigo";
$Sentencia = $BaseDatos->Conexion->prepare($SQL);
...
$Pantalla = str_replace("{paistrabaja}", $PaisTrabaja, $Pantalla);

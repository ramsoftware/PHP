...
class basedatos{
	...
	//Sentencias para llenar el siguiente combobox encadenado poco a poco
	function ComboBoxDinamico2($Tabla, $valorCampo, $textoCampo, $CampoCondicion, $Condicion, $Busca){
		$this->Conectar();
		if ($Busca == ""){
	...
	function ComboBoxLleno($Tabla, $Nombre, $Codigo){
		$this->Conectar();

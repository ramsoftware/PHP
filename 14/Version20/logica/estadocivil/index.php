...
if (isset($_GET["codigo"])){
	...
	$Registros = $objEstadoCivil->Grid($Codigo, true, $Posicion);
}
else 
	$Registros = $objEstadoCivil->Grid(-1, false, $Posicion);
...
//Respuesta HTML
$Pantalla = file_get_contents("../../visual/estadocivil/index.html");
